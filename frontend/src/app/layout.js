...
export default function RootLayout ({ children }) {
  return (
    <html lang="es" className={K2DFont.className}>
      <body className='relative after:shadow-orange-500/40 after:w-40 after:h-40 after:rotate-45 after:shadow-lg after:bg-orange-500 after:-z-10 after:rounded-xl after:absolute after:-top-6 after:-left-6' style={
        {
          background:
